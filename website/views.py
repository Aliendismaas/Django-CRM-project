...
def  register_user(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			#Authenticatin User After Filling out the form
...
def customer_record(request, pk):
	if request.user.is_authenticated:
		...
		messages.success(request, "You must Login to view this record...")
		return redirect('home')
...
def  add_record(request):
	...
	if request.user.is_authenticated:
		...
		messages.success(request, "You must be logged in to this Operation...")
		return redirect('home')
